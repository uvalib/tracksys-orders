   ...
   <footer role="contentinfo">
      ...
      <div class="footer-container">
         <div class="footer-block">
            ...
            <ul>
               <li><a href="https://library.virginia.edu/services">Research: Search, borrow, request</a></li>
               <li><a href="https://library.virginia.edu/teaching-and-writing">Teaching &amp; publication</a></li>
               <li><a href="https://library.virginia.edu/spaces">Library spaces</a></li>
               <li><a href="https://library.virginia.edu/equipment-and-techh">Equipment &amp; technology</a></li>
               <li><a href="https://library.virginia.edu/help">Get help</a></li>
            </ul>
         </div>

         <div class="footer-block">
            <h2>
               <a href="https://library.virginia.edu/about-uva-library">About</a>
            </h2>
            <ul>
               <li><a href="https://library.virginia.edu/jobs/">Jobs and fellowships</a></li>
            ...
            <p>
               <a href="https://library.virginia.edu/status">Status dashboard</a>
            </p>
         </div>
...
.footer-container {
   ...
   .social-media {
      ...
      .facebook, .instagram {
         ...
         fill: #fff;
         &:hover {
            fill: var(--uvalib-brand-orange) !important;
         }
      }
   }
   address {
